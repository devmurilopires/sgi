    ...
    def exportar_dashboard_pdf(self, filepath, periodo_str, kpis, selecoes, imagens, dados_tabela=None):
        ...
        try:
            ...
            def add_graficos_lado_a_lado(k1, k2):
                ...
                c1 = [Paragraph(graficos_meta[k1][0], heading_side), Paragraph(graficos_meta[k1][1], normal_side), Spacer(1, 5), RLImage(imagens[k1], width=250, height=140)]
                c2 = [Paragraph(graficos_meta[k2][0], heading_side), Paragraph(graficos_meta[k2][1], normal_side), Spacer(1, 5), RLImage(imagens[k2], width=250, height=140)]
