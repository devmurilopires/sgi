...
class ParecerView(ctk.CTkFrame):
    ...
    def _construir_interface(self):
        ...
        btn_add_id = ctk.CTkButton(row_id, text="➕ Adicionar ID", fg_color=COLOR_PRIMARY, font=("Arial Bold", 13), height=35, hover_color=COLOR_HOVER, command=self._adicionar_ids)
        ...
        ctk.CTkButton(footer_frame, text="📄 GERAR PARECER TÉCNICO", fg_color=COLOR_PRIMARY, font=("Arial Bold", 16), height=50, width=300, hover_color=COLOR_HOVER, command=self._acao_gerar_parecer).pack(side="right", padx=10)
